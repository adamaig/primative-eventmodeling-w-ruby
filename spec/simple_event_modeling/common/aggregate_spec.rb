...
RSpec.describe SimpleEventModeling::Common::Aggregate do
  ...
  describe '#on' do
    it 'should raise NotImplementedError if not implemented in base class' do
      expect { aggregate.on(:event) }.to raise_error(NotImplementedError, 'You must implement the on method')
    end
  end

  describe '#handle' do
    it 'should raise NotImplementedError if not implemented in base class' do
      expect { aggregate.handle(:command) }.to raise_error(NotImplementedError, 'You must implement the handle method')
    end
  end
